...
public class SubscriptionControllerImpl implements SubscriptionController {
  ...
  public ResponseEntity<String> createSubscription(@RequestBody Subscription subscription) {
    try {
      ...
      return new ResponseEntity<>(subscription.getSlug(), HttpStatus.CREATED);
  ...
  @Override
  @RequestMapping(value = "/categories/{categories}/labels/{labels}", method = RequestMethod.GET,
      produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @RequestMapping(value = "/categories/{categories}", method = RequestMethod.GET,
      produces = MediaType.APPLICATION_JSON_VALUE)
  public List<Subscription> findInSubscribedCategories(@PathVariable String[] categories) {
    List<Subscription> result;
    try {
      result = subscriptionHandler.findInSubscribedCategoriesOrSubscribedLabels(categories,
          new String[] {});
    } catch (NotFoundException | DataValidationException | ServiceException | ClientException e) {
      logger.error(e.getMessage(), e);
      throw e;
  ...
  @Override
  @RequestMapping(value = "/labels/{labels}", method = RequestMethod.GET,
      produces = MediaType.APPLICATION_JSON_VALUE)
  public List<Subscription> findInSubscribedLabels(@PathVariable String[] labels) {
    List<Subscription> result;
    try {
      result =
          subscriptionHandler.findInSubscribedCategoriesOrSubscribedLabels(new String[] {}, labels);
    } catch (NotFoundException | DataValidationException | ServiceException | ClientException e) {
      logger.error(e.getMessage(), e);
      throw e;
    } catch (Exception e) {
