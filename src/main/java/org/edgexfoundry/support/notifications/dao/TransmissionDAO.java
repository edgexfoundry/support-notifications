...
public interface TransmissionDAO extends MongoRepository<Transmission, String> {
	...
	public List<Transmission> findByStatusAndResendCountLessThan(TransmissionStatus status, int resendLimit);

	public Page<Transmission> findByStatusAndResendCountLessThan(TransmissionStatus status, int resendLimit,
			Pageable pageable);
	...
	public void deleteByStatusAndResendCountGreaterThanEqualAndModifiedBefore(TransmissionStatus status, int resendCount, long end);
