...
//	@Query("{ 'labels': { '$in': ?0 } }")
	...
	public List<Notification> findBySeverityAndStatus(NotificationSeverity severity, NotificationStatus status);

	public Page<Notification> findBySeverityAndStatus(NotificationSeverity severity, NotificationStatus status,
			Pageable pageable);
